    ...
    <div class="main" ref="containerRef">
        ...
        <div class="data">
            <el-table :data="tableData" border style="width: 100%" :height="tableHeight" @row-click="handleRow"
                ...
                <el-table-column prop="oldPrice" label="原价" width="200" />
                <el-table-column prop="description" label="描述" width="200" />
                <el-table-column prop="categoryId" label="类别ID" width="200" />
                <el-table-column prop="descPre" label="descPre" width="200" />
        ...
        <div class="form">
            <el-dialog v-model="dialogVisible" :title="dialogTitle" width="800" draggable @close="clearDialogForm">
                <el-form>
                    <el-row :gutter="20">
                        <el-col :span="12">
                            <el-form-item label="商品名：" label-width="100">
                    ...
                    <el-row :gutter="20">
                        <el-col :span="12">
                            <el-form-item label="原价：" label-width="100">
                                <el-input v-model="productInfo.oldPrice" />
                            </el-form-item>
                        </el-col>
                        <el-col :span="12">
                    ...
                    <el-row :gutter="20">
                        <el-col :span="12">
                            <el-form-item label="类别ID：" label-width="100">
                                <el-input v-model="productInfo.categoryId" />
                            </el-form-item>
                        </el-col>
                        <el-col :span="12">
                            <el-form-item label="descPre：" label-width="100">
                                <el-input v-model="productInfo.descPre" />
                            </el-form-item>
                        </el-col>
                    </el-row>
                    <el-row :gutter="20">
                        <el-col :span="12">
                            <el-form-item label="是否已删除：" label-width="100">
                                <el-input v-model="productInfo.isDel" />
                            </el-form-item>
                        </el-col>
                    </el-row>
                </el-form>
...
import {
    ...
    addProduct as apiAddProduct, deleteByIds as apiDeleteByIds, updateProduct as apiUpdateProduct
} from '@/api/ProductApi';
...
function handleRow(row, column, event) {
    ...
    if (prepareEdit === true) {
        prepareEdit = false;
        changingId = row.id;
        productInfo.value = Object.assign({}, row);
...
async function onDialogSubmit() {
    ...
    if (changingId == null) {
        ...
        resp = await apiAddProduct(productInfo.value);
        if (resp.success) {
            ElMessage({
                type: 'success',
                message: '添加成功',
        ...
        productInfo.value.id = changingId;
        resp = await apiUpdateProduct(productInfo.value);
        if (resp.success) {
            ElMessage({
                type: 'success',
                message: '修改成功',

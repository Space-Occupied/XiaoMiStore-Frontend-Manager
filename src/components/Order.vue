    ...
    <div class="main" ref="containerRef">
        ...
        <div class="data">
            <el-table :data="tableData" border style="width: 100%" :height="tableHeight" @row-click="handleRow"
                ...
                <el-table-column prop="phoneNum" label="收货人手机号" width="200" />
                <el-table-column prop="address" label="收货人地址" width="200" />
                <el-table-column prop="userRealName" label="收货人姓名" width="200" />
                    ...
                    <el-row :gutter="20">
                        <el-col :span="12">
                            <el-form-item label="总价：" label-width="100">
                                <el-input v-model="orderInfo.totalPrice" />
                            </el-form-item>
                        </el-col>
                        <el-col :span="12">
                            <el-form-item label="状态：" label-width="100">
                                <el-input v-model="orderInfo.status" />
                            </el-form-item>
                        </el-col>
                    </el-row>
                    <el-row :gutter="20">
                        <el-col :span="12">
                            <el-form-item label="用户ID：" label-width="100">
                                <el-input v-model="orderInfo.userId" />
                            </el-form-item>
                        </el-col>
                        <el-col :span="12">
                            <el-form-item label="创建时间：" label-width="100">
                                <el-input v-model="orderInfo.createTime" />
                            </el-form-item>
                        </el-col>
                    </el-row>
                    <el-row :gutter="20">
                        <el-col :span="12">
                            <el-form-item label="是否已删除：" label-width="100">
                                <el-input v-model="orderInfo.isDel" />
                            </el-form-item>
                        </el-col>
                        <el-col :span="12">
                            <el-form-item label="收货人手机号：" label-width="100">
                                <el-input v-model="orderInfo.phoneNum" />
                            </el-form-item>
                        </el-col>
                    </el-row>
                    <el-row :gutter="20">
                        <el-col :span="12">
                            <el-form-item label="收货人地址：" label-width="100">
                                <el-input v-model="orderInfo.address" />
                            </el-form-item>
                        </el-col>
                        <el-col :span="12">
                            <el-form-item label="收货人姓名：" label-width="100">
                                <el-input v-model="orderInfo.userRealName" />
                            </el-form-item>
                        </el-col>
                    </el-row>
                </el-form>
...
import {
    ...
    addOrder as apiAddOrder, deleteByIds as apiDeleteByIds, updateOrder as apiUpdateOrder
} from '@/api/OrderApi';
...
function handleRow(row, column, event) {
    ...
    if (prepareEdit === true) {
        prepareEdit = false;
        changingId = row.id;
        orderInfo.value = Object.assign({}, row);
...
async function onDialogSubmit() {
    let resp = null;
    if (changingId == null) {
        orderInfo.value.id = null;
        resp = await apiAddOrder(orderInfo.value);
        if (resp.success) {
            ElMessage({
                type: 'success',
                message: '添加成功',
        ...
        orderInfo.value.id = changingId;
        resp = await apiUpdateOrder(orderInfo.value);
        if (resp.success) {
            ElMessage({
                type: 'success',
                message: '修改成功',
